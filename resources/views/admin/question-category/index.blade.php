    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title category_title">Add Category</h5>
        ...
        $("#category_form").validate({
            ...
            rules: {
                title: {
                    required: true,
                    remote:{
                        url: base_url + 'check-unique-q-category',
                        type:'POST',
            ...
            messages: {
                title: {
                    ...
                    remote:"The category is already taken",
