    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Topic Listing</span>
            </div>
...
<div class="card">
    <div class="card-header bg-white header-elements-inline">
        <h5>Topic</h5>
        <a href=".add_modal" data-toggle="modal" data-backdrop="static" data-keyboard="false" class="btn btn-primary rounded-round add_topic"><i class="icon-plus2"></i> Add Topic</a>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-3">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title topic">Add Topic</h5>
                <button type="button" class="close custom_close" data-dismiss="modal">×</button>
            </div>
            <form action="{{ route('topic.store') }}" method="POST" name="topic_form" id="topic_form" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-form-label pl-2 topic_label">Add Topic:<span class="text-danger">*</span></label>
                        <div class="input-group custom-start col-md-12">
                            <input type="text" value="" name="title" placeholder="Enter Topic" class="form-control topic "/>
                        </div>
...
<script>
    ...
    var topicTable = "";
    var active_link = "{{ route('admin.change-topic-status') }}";

    var filter = "{{ route('topic-filter') }}";
    var oldImage = '';
    var flag = 1;
...
$(document).ready( function () {
    ...
    $(document).on('click','.add_topic',function(){
        $('.topic').text('Add Topic');
        $('.topic_label').html('Add Topic: <span class="text-danger">*</span>');
    })

    $(document).on('click','.edit_topic',function(){
        var $this = $(this);
        $('.topic').text('Edit Topic');
        $('.topic_label').html('Edit Topic: <span class="text-danger">*</span>');
