...
@php
    ...
    $img_url = (isset($comment->commenter->logo) && $comment->commenter->logo != '') ? $ProfileUrl . $comment->commenter->logo : $ProfileUrl.'default.png';
@endphp 
@php($markdown->setSafeMode(false))
<div id="comment-{{ $comment->getKey() }}" class="media">
    ...
    <div class="profile-image">
        <img class="mr-3" src="{{ $img_url }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar" height="50" width="50">
    </div>
